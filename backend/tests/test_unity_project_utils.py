...
def test_write_meta_creates_meta_file(tmp_path):
...
def test_write_script_meta(tmp_path):
...
def test_write_texture_meta(tmp_path):
...
def test_write_audio_meta(tmp_path):
...
def test_save_image_with_base64(tmp_path):
...
def test_save_image_with_url(tmp_path):
...
def test_save_image_with_list(tmp_path):
...
def test_save_audio_with_bytes(tmp_path):
...
def test_save_audio_with_url(tmp_path):
...
def test_get_latest_project_path_empty(tmp_path, monkeypatch):
...
def test_get_latest_project_path_returns_latest(tmp_path, monkeypatch):
...
def test_create_unity_project_structure(tmp_path, monkeypatch):

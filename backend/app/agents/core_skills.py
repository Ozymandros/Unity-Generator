...
class TextSkill:
    ...
    @kernel_function(
        name="trim_text", description="Trims whitespace from the start and end of text."
    )
    ...
    @kernel_function(name="uppercase_text", description="Converts text to uppercase.")
    ...
    @kernel_function(name="lowercase_text", description="Converts text to lowercase.")
...
class MathSkill:
    ...
    @kernel_function(name="add_numbers", description="Adds two numbers together.")

...
class BaseProviderAdapter(ABC):
    ...
    @staticmethod
    def get_opt(options: dict[str, Any], key: str, default: Any) -> Any:
        """
        Safely extract an option from a dict or Pydantic model.

        Args:
            options: Options dict (or Pydantic model converted to dict).

...
"""
    ...
    def generate_csharp(self, prompt: str, unity_version: Optional[str] = None) -> str:
        """
...
class UnityProjectSkill:
    ...
    def __init__(self, output_root: Optional[Path] = None):
        ...
        LOGGER.info(f"UnityProjectSkill initialized with output root: {self.output_root}")
    ...
    def write_asset(self, relative_path: str, content: str) -> str:
        ...
        safe_path = safe_path.relative_to(".") if str(safe_path).startswith("..") else safe_path

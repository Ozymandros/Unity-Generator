...
def _build_sk_service(
    ...
    # Non-OpenAI-compatible providers (Google, Anthropic) need native
    # SK connectors that are not yet installed.
    raise NotImplementedError(
        f"Provider '{provider}' is not currently supported in UnityAgent. "
        "Please use OpenAI, Azure, DeepSeek, OpenRouter, or Groq."
    )

...
class UnityProjectPlugin:
    ...
    def __init__(self, output_root: Optional[Path] = None):
        ...
        LOGGER.info(f"UnityProjectPlugin initialized with output root: {self.output_root}")
...
"""
        ...
        try:
            ...
            raise IOError(f"Failed to write .meta file: {e}")
    ...
    def write_csharp_script(
        ...
        safe_script_name = "".join(c if c.isalnum() or c in "_-" else "_" for c in script_name.strip())
        ...
        try:
            ...
            raise ValueError(f"Script path would escape project directory: {script_path}")
        ...
        try:
            ...
            raise IOError(f"Failed to write script: {e}")
